...
public class FirebaseStorageServiceImpl implements FirebaseStorageService {
    ...
    private String uploadFile(File file, String carpeta, String fileName) throws IOException {
        ...
        ClassPathResource json = new ClassPathResource(rutaJsonFile + File.separator + archivoJsonFile); //ruta donde esta mi archivo json
    ...
    private String sacaNumero(long id) {
        ...
        //Ej si mi id + 10 - 0000000000000000010
